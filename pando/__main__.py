...
PARSER.add_argument('-w', '--wgs_qc', help='Path to WGS QC',
                    default='/mnt/seq/MDU/QC/', required=False)
PARSER.add_argument('-N', '--Nullarbor_folders', help='Are you running this on\
                    a set of folders generated by Nullarbor?',
                    default=False, action="store_true", required=False)
PARSER.add_argument('-k', '--keep_tempdirs', help='Keep tempdirs created\
