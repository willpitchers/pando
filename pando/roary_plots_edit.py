...
__version__ = '0.1.0, Schultz edit'
#Original version at https://raw.githubusercontent.com/sanger-pathogens/Roary/master/contrib/roary_plots/roary_plots.py
...
#     print roary_sorted
    ...
    with sns.axes_style('whitegrid'):
        ...
        ax1=plt.subplot2grid((1,40), (0, 10), colspan=100)
#         print help(ax1)
        a=ax1.matshow(roary_sorted.T, cmap=plt.cm.Greys,
                   vmin=0, vmax=1,
                   aspect='auto'#,
#removed interpolation to prevent the gradient effect
#                   interpolation='None',
                    )
        ax1.set_yticks([])
        ax1.set_xticks([])
